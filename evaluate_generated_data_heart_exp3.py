...
def main():
    ...
    # fake_data = 'heart-disease-binary-t1_TrainUpsampledPatient_size-50'
    # fake_data = 'heart-disease-binary-t2_TrainUpsampledPatient_size-50'
    # fake_data = 'heart-disease-binary-t3_TrainUpsampledPatient_size-50'
    # fake_data = 'heart-disease-binary-t4_TrainUpsampledPatient_size-50'
    fake_data = 'heart-disease-binary-t5_TrainUpsampledPatient_size-50'
    ...
    assert synthetic_data.shape == (50, train_data.shape[1]), "Error! Synthetic data not correctly loaded."

    print(f"train_data.shape = {train_data.shape}")

    train_features = train_data[:, :num_vars]

    def normalizeFeaturesForGAN(features):
    ...
    train_features = normalizeFeaturesForGAN(train_features)
    ...
    test_features = normalizeFeaturesForGAN(test_features)
