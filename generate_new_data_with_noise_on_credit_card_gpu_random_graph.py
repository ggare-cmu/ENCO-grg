...
def main():
    ...
    # randomGraph = 'randomGraph_R3'
    # randomGraph = 'randomGraph_P30_R3'
    randomGraph = 'randomGraph_N30_R3'
    
    trial = f"{trial}_{randomGraph}"
    ...
    causal_discovery_exp_dir = f"/home/grg/Research/ENCO-grg/checkpoints/2022_10_22_Acyclic_{task}_TrainUpsampledPatient_T1_{randomGraph}"
    ...
    load_model_dir = f"{causal_discovery_exp_dir}/generateContinousSamples_{num_samples}_marco_AuC_T0_{randomGraph}"
