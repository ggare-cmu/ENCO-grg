...
def main():
    ...
    task = 'ModelBiomarkers-max'
    # task = 'diabetes-t5' #'heart-disease-binary-t2' #'dermatology' #'heart-disease-binary'
    # task = 'diabetes-small5' #'heart-disease-binary-t2' #'dermatology' #'heart-disease-binary'
    # task = 'heart-disease-binary-t5' #'dermatology' #'heart-disease-binary'
    # task = 'heart-disease-t5' #'dermatology' #'heart-disease-binary'
    # task = 'credit_card_fraud-size4' #'dermatology' #'heart-disease-binary'
    # task = 'breast_cancer_wisconsin-t2' #'dermatology' #'heart-disease-binary'
    # task = 'dermatology-t1' #'dermatology' #'heart-disease-binary'
    ...
    num_samples = 50 #200 #200 #3000 #500 #1000
    ...
    # new_train_data = []
    # for var, x in zip(features_list, train_data.T):
    
    #     var_unique = np.unique(x).tolist()
        
    #     var_type = feature_type_dict[var]

    #     if var_type == 'binary':

    #         new_train_data.append(x)

    #         assert var_unique == [0,1], "Error! Wrong var type for var {var}."

    #     elif var_type == 'binary-class':
    ...
    #         assert len(var_unique) <= 20, "Error! Wrong var type for var {var}."
    ...
    #     else:
    #         raise Exception(F"Error! Wrong var type encountered - {var_type}.")

    # new_train_data = np.vstack(new_train_data).T
    # assert train_data.shape == new_train_data.shape, "Error! Type conversion wrong."
