...
def fitLargeMLP(train_label_ft, test_label_ft, gt_train_scores, gt_test_scores, 
    ...
    for idx in range(n_trial):
        ...
        # if feature_type != "":
        if feature_type != "" and feature_type != "binary-class":
            clf = MLPRegressor(
...
def main():
    ...
    # task = 'heart-disease-binary-t3' #'dermatology' #'heart-disease-binary'
    # task = 'heart-disease-t1' #'dermatology' #'heart-disease-binary'
    # task = 'credit_card_fraud-size4' #'dermatology' #'heart-disease-binary'
    task = 'breast_cancer_wisconsin-t5' #'dermatology' #'heart-disease-binary'
    # task = 'dermatology-t5' #'dermatology' #'heart-disease-binary'
